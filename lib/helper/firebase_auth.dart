...
Future<void> firebaseRegister ({required String emailAddress,required String password}) async {
  ...
  if (e.code == 'weak-password') {
    ...
    showToast(backgroundColor: Colors.black,text: "The account already exists for that email.");
  }
} catch (e) {
  print(e);
}
...
Future<void> firebaseLogin (context,{required String mail, required String password})async {
  try {
    ...
    if (e.code == 'user-not-found') {
      ...
      showToast(backgroundColor: Colors.black,text: "Wrong password provided for that user.");
